...
class ParametresRoute extends StatelessWidget {
  ParametresRoute({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Center(
            child: Text('Ceci est une page de test', style: TextStyle(color: Colors.white70)),
          ),
          AppBar(
